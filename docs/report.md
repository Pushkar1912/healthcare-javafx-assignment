...
This healthcare system was built using JavaFX, MySQL, and Maven. While these are solid choices for the assignment's requirements, I ran into some real challenges that made me think about better alternatives.

### The Problems I Faced

**JavaFX Limitations**
- JavaFX is getting less support from Oracle, which raises questions about long-term maintenance
...
I chose a relational database structure because healthcare data has lots of connections - patients have beds, staff have shifts, medications have prescriptions. This made sense at the time, but I learned that sometimes simpler is better.

**User Interface Approach**
I went with separate dashboards for different roles (Manager, Doctor, Nurse) because each role needs different information. This was the right call - it keeps things organized and reduces confusion.

**Testing Strategy**
I created both unit tests (testing individual pieces) and integration tests (testing everything together). This dual approach caught more bugs and gave me confidence that the system actually works.

### What I Learned

**Start Simple, Then Add Complexity**
I tried to build everything at once, which made debugging harder. Next time, I'd start with just patient management, then add medications, then add scheduling.

**User Feedback is Crucial**
I built what I thought healthcare workers needed, but I should have talked to actual nurses and doctors first. They know their workflow better than I do.

**Security Should Come First**
Healthcare data is sensitive. I should have planned security from day one, not added it later. Things like encryption, audit logs, and access controls need to be built-in, not bolted on.
...
Building a healthcare management system taught me that technology is just a tool. The real challenge is understanding how healthcare actually works and building something that makes people's jobs easier, not harder.
...
My next version would focus on being useful, reliable, and easy to use rather than having every possible feature. Sometimes less really is more.
